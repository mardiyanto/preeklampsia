    ...
    $no++;    
                                        echo"<tbody>
                                            <tr>
                                                <td>$no</td>
                                                <td>$t[nama_pasien]</td> 
                                                <td><button type='button' class='btn btn-info' data-toggle='modal' data-target='#bmi$t[id_pasien]'>BMI</button></td> 
                                                <td><button type='button' class='btn btn-info' data-toggle='modal' data-target='#map$t[id_pasien]'>MAP</button></td> 
                                                <td><button type='button' class='btn btn-info' data-toggle='modal' data-target='#rot$t[id_pasien]'>ROT</button></td> 
...
elseif($_GET['aksi']=='inputsuara'){
                ...
                <div class='row'>
                                <div class='col-lg-12'>
                                    <div class='panel panel-default'>
                                        ...
                                        <div class='panel-body'>
                <form id='form1'  method='post' action='input.php?aksi=inputsuarapasien'>
                <div class='form-group'>
                ...
                <option value='' selected>pilih pasien</option>"; 
                 $sql=mysqli_query($koneksi,"SELECT * FROM pasien ORDER BY id_pasien");
                 while ($c=mysqli_fetch_array($sql))
                 {
                    echo "<option value=$c[id_pasien]>$c[nama_pasien]</option>";
                 }
                    echo "
                </select><br><br>
    ...
    <div class='col-lg-12'>
                ...
                Data suara
                       ...
                       <div class='panel-body'>
                        ...
                        ";
                        $no=0;
                    $tebaru=mysqli_query($koneksi," SELECT * FROM suara,pasien,tps,desa,kecamatan WHERE suara.id_pasien=pasien.id_pasien 
